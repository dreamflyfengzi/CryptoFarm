import FLOWER_PLANTS from './static/FLOWER_PLANTS'
export default class staticData {
  ...
  public static INDEX_DATA = [
    ...
    // 01
    {
      ...
      "seed_data": {
        ...
        'grow_time_tol': '', //生长总时间
        'mature_time': '', //当前成熟时间
        'grow_static': 0,//当前生长状态 1发芽期、2生长期、3花苞期、4成熟期
        'water_time': '', //可以浇水时间
        'is_water': '', //是否可以浇水 1是2否:"10"
      }
    },
    // 02
    {
      ...
      "ain": "",
      "msg": "",
      "fat_time": 100, //大于0 显示施肥框 説明正在加速生長
      "fat_time_tol": 1000,
      "seed_data": {
        'id': "",//'花卉ID',
        'name': "",//'花卉名称',
  ...
  // 肥料數據
  public static FAT_LIST = [
    {
      'id': "sf01",//'施肥ID',
      'name': "普通施肥",//'施肥名称',
      'pic': 'farm/shifei_sf01',//图标
      'ain': '',//动画
      'grade': "1",//'施肥等级',
      'num': "0",//'施肥增加产量',
      'num2': "5",//'施肥加快生长时间百份比',
  ...
  public getFarmInitFlowerGrade(msg) {
  ...
  //成长
  public farmInitGrowFlower(id, seed_data) {
    for (var i in staticData.INDEX_DATA) {
      if (staticData.INDEX_DATA[i].ff_id == id) {
